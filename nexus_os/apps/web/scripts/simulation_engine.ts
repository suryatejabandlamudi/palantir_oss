...
async function createAlert(title: string, category: string, severity: string, message: string) {
...
async function logToTerminal(type: string, message: string) {
...
async function runSimulation() {
    await seedFleet();
    console.log("🚀 Simulation Engine Started via Prisma...");
